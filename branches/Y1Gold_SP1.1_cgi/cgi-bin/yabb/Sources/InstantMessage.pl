...
~;
	if( @immessages ) {
		$yymain .= qq~    <a href="javascript:DoConfirm('$txt{'412'}?','$cgi;action=imremoveall;caller=1')">$img{'im_delete'}</a>$menusep~;
	}
	...
	for( $counter = 0; $counter < @immessages; $counter++ ) {
		...
		$yymain .= qq~
		  <tr>
		    ...
		    <td class="$windowcss" bgcolor="$windowbg"><font size=2><a href="javascript:DoConfirm('$txt{'739'}','$cgi;action=imremove;caller=1;id=$messageid')">$img{'im_remove'}</a></font> </td>
		  </tr>
		~;
	}
...
$yymain .= qq~
		$menusep<a href="javascript:DoConfirm('$txt{'739'}','$cgi;action=imremove;caller=1;id=$messageid')">$img{'im_remove'}</a>
        </font></td>
      </tr>
    </table>
    </td>
...
~;
	if( @ommessages ) {
		$yymain .= qq~    <a href="javascript:DoConfirm('$txt{'412'}?','$cgi;action=imremoveall;caller=2')">$img{'im_delete'}</a>$menusep~;
	}
	$yymain .= qq~
...
~;
  ...
  <tr>
    ...
    <td class="$windowcss" bgcolor="$windowbg"><font size=2><a href="javascript:DoConfirm('$txt{'739'}','$cgi;action=imremove;caller=2;id=$messageid')">$img{'im_remove'}</a></font></td>
  </tr>
~;
	}
...
$yymain .= qq~
        $menusep<a href="javascript:DoConfirm('$txt{'739'}','$cgi;action=imremove;caller=2;id=$messageid')">$img{'im_remove'}</a>
        </font></td>
      </tr>
    </table>
    </td>
