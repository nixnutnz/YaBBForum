...
<table border=0 width="80%" cellspacing="1" cellpadding="0" bgcolor="$color{'bordercolor'}" class="bordercolor" align="center">
  <tr>
    ...
    <table class="titlebg" bgcolor="$color{'titlebg'}" width="100%">
      <tr>
        <td><img src="$imagesdir/search.gif" alt=""> <font size=2 class="text1" color="$color{'titletext'}"><b>$txt{'183'}</b></font></td>
      </tr>
    </table>
    </td>
  </tr><tr>
...
<table border=0 width=100% cellspacing=1 bgcolor="$color{'bordercolor'}">
  <tr>
    ...
    <td width="75%" bgcolor="$color{'titlebg'}"><font class="text1" color="$color{'titletext'}" size=2><b>&nbsp;$catname{$cat{$board}} / $boardinfo{$board}->[0] / <a href="$scripturl?board=$board;action=display;num=$tnum;start=$msgnum"><font class="text1" color="$color{'titletext'}" size=2><u>$msub</u></font></a></b></font></td>
