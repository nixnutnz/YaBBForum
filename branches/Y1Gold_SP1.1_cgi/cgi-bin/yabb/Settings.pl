...
$mbname = "My YaBB 1 Gold - SP 1.1";                                  # The name of your YaBB forum
...
$webmaster_email = q^webmaster@mysite.com^;                           # Your email address. (eg: $webmaster_email = q^admin@host.com^;)
...
$imagesdir = "http://www.mysite.com/YaBBImages";                      # URL to your images folder
$ubbcjspath = "http://www.mysite.com/ubbc.js";                        # URL to your 'ubbc.js' (REQUIRED for post/modify to work properly)
$faderpath = "http://www.mysite.com/fader.js";                        # URL to your 'fader.js'
$helpfile = "http://www.mysite.com/YaBBHelp/index.html";              # URL to your help file
