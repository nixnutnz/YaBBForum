    ...
    for (@threadlist) {
        ...
        if ($accept_permalink) {
            ...
            $yymain .= q~       <item>
                ...
                <link>~
              . RSSDescriptionTrim(
                "https://$perm_domain/$symlink$permdate/$currentboard/$curnum")
              . q~</link>
...
sub RSS_recent {
    ...
    for my $i ( 0 .. $#threadlist ) {
        ...
        if ($accept_permalink) {
            ...
            <link>~
              . RSSDescriptionTrim(
                "https://$perm_domain/$symlink$permdate/$board/$curnum")
              . q~</link>
            <category>~ . RSSDescriptionTrim($category) . q~</category>
            <guid isPermaLink="true">~
              . RSSDescriptionTrim(
...
# Removed per Corey's suggestion: https://yabbforum.nzYaBB.pl?num=1142571424/20#20
#my $docs = "       <docs>https://$perm_domain</docs>\n" if $perm_domain;
